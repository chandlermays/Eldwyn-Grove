...
namespace EldwynGrove.Saving
{
    ...
    public class SaveableEntity : MonoBehaviour
    {
        ...
        {
            // If the ID does not already exist in the glossary, we can add it - OR if the ID belongs to this instance - OR if the existing ID is null
            if (!m_idGlossary.TryGetValue(entity, out var existingEntity) || existingEntity == this || existingEntity == null)
            {
